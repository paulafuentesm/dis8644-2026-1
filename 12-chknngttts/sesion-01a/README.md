...
- ### Pauline Oliveros (1932)
  - Le interesan los sonidos de autos
    - Motores, Estatica de radio
  - Grababa sonidos en espacios publicos
  ...
  - ### Wendy Carlos (1939)
    ...
    - Trabajó en soundtracks para peliculas
      - Clockwork Orange:
  ...
  - ### Laurie Spiegel (1945)
    - Menciona la precision de los computadores
    - Interacción con el sonido
    - "Los computadores eran la deshumanización de la musica"
      - Excepto para los que lo veian como una liberalización
    - Veía la tecnologia como una extensión de uno mismo
      - Uno le dice que hacer a la maquina, no al revés
  ...
  - ## Wendy Carlos Deeper'ish Dive
    - Video con sintetizadores Moog en 1970 BBC:
      ...
      - Muestra que con filtros (EQ si no me equivoco) se pueden crear nuevos sonidos más complejos a partir de los waves basicos
    - Con esa marca de sintetizadores produjo Switched-On Bach
      - Que terminó ganando 3 grammy
      - Y en 1986 se certifica platino
    - Es ultra pionera de la musica electronica
